    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          ...
          <div className="flex h-full min-h-0 w-full flex-col overscroll-contain" dir="rtl">
            {children}
          </div>
        </SheetContent>
      </Sheet>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "size-10 min-h-10 min-w-10 touch-manipulation sm:size-8 sm:min-h-8 sm:min-w-8",
        className
      )}
      onClick={(event) => {
        onClick?.(event)
