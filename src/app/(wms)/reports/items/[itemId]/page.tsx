...
export default async function ItemReportPage({
  ...
  const pdfPayload = await getItemReportPdfPayload(itemId, pdfParams)
  ...
  return (
    <div className="min-w-0 max-w-full space-y-8">
      ...
      <ItemReportFiltersBlock itemId={itemId} initial={toReportPeriodFilterInitial(period)} activeQuery={canonical} />
